...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChallengeResult'
        db.create_table(u'accounts_challengeresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['problems.Category'])),
            ('result', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'accounts', ['ChallengeResult'])

        # Adding M2M table for field challenge_best on 'UserProgress'
        m2m_table_name = db.shorten_name(u'accounts_userprogress_challenge_best')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprogress', models.ForeignKey(orm[u'accounts.userprogress'], null=False)),
            ('challengeresult', models.ForeignKey(orm[u'accounts.challengeresult'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprogress_id', 'challengeresult_id'])


    def backwards(self, orm):
        # Deleting model 'ChallengeResult'
        db.delete_table(u'accounts_challengeresult')

        # Removing M2M table for field challenge_best on 'UserProgress'
        db.delete_table(db.shorten_name(u'accounts_userprogress_challenge_best'))
